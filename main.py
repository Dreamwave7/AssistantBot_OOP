...
def main():
    ...
    print(background(color("WRITE HELP TO SEE ALL COMMANDS               ",Colors.purple),Colors.blue))
    print(background(color("WRITE 'exit', 'close' or 'bye' for close bot ",Colors.purple),Colors.blue))
